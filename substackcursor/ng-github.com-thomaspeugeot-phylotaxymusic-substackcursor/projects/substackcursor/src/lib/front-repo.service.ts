...
export const StackType = "github.com/thomaspeugeot/phylotaxymusic/substackcursor/go/models"
...
export class FrontRepoService {
	...
	public connectToWebSocket(GONG__StackPath: string): Observable<FrontRepo> {
		...
		let basePath = 'ws://localhost:8080/api/github.com/thomaspeugeot/phylotaxymusic/substackcursor/go/v1/ws/stage'
