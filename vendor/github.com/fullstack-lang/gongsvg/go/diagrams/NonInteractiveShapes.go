...
var map_DocLink_Identifier_NonInteractiveShapes map[string]any = map[string]any{
...
// 	InjectionGateway["NonInteractiveShapes"] = NonInteractiveShapesInjection
// }

// NonInteractiveShapesInjection will stage objects of database "NonInteractiveShapes"
func NonInteractiveShapesInjection(stage *models.StageStruct) {
