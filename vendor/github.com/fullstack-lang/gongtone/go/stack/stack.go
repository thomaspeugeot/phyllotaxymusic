...
import (
	...
	"github.com/fullstack-lang/gongtone/go/fullstack"
	"github.com/fullstack-lang/gongtone/go/models"
	"github.com/fullstack-lang/gongtone/go/orm"
	"github.com/fullstack-lang/gongtone/go/probe"

	gongtone_go "github.com/fullstack-lang/gongtone/go"
...
func (impl *BeforeCommitImplementation) BeforeCommit(stage *models.StageStruct) {
	...
	stage.Checkout()
	stage.Marshall(file, "github.com/fullstack-lang/gongtone/go/models", "main")
}
...
func NewStack(
	...
	if withProbe {
		stack.Probe = probe.NewProbe(r, gongtone_go.GoModelsDir, gongtone_go.GoDiagramsDir,
