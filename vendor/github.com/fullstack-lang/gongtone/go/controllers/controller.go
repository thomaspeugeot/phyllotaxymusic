...
import (
	...
	gongtone_orm "github.com/fullstack-lang/gongtone/go/orm"
...
type Controller struct {
	...
	Map_BackRepos map[string]*gongtone_orm.BackRepoStruct
}
...
func GetController() *Controller {
	doControllerInitOnce.Do(func() {
		_controllerSingloton = &Controller{
			Map_BackRepos: make(map[string]*gongtone_orm.BackRepoStruct),
		}
	})
	return _controllerSingloton
}

func (controller *Controller) AddBackRepo(backRepo *gongtone_orm.BackRepoStruct, stackPath string) {
