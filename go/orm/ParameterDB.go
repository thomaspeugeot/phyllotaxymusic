...
type ParameterDB struct {
	...
	// Declation for basic field parameterDB.DiamondAngle
...
func (parameterDB *ParameterDB) CopyBasicFieldsFromParameter(parameter *models.Parameter) {
	...
	parameterDB.DiamondAngle_Data.Float64 = parameter.DiamondAngle
	parameterDB.DiamondAngle_Data.Valid = true
...
func (parameterDB *ParameterDB) CopyBasicFieldsToParameter(parameter *models.Parameter) {
	...
	parameter.DiamondAngle = parameterDB.DiamondAngle_Data.Float64
