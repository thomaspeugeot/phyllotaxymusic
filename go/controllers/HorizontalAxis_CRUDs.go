...
func (controller *Controller) GetHorizontalAxiss(c *gin.Context) {
	...
	if len(_values) == 1 {
		...
		if len(value) == 1 {
			stackPath = value[0]
			// log.Println("GetHorizontalAxiss", "Name", stackPath)
		}
	}
...
func (controller *Controller) PostHorizontalAxis(c *gin.Context) {
	...
	if len(_values) == 1 {
		...
		if len(value) == 1 {
			stackPath = value[0]
			// log.Println("PostHorizontalAxiss", "Name", stackPath)
		}
	}
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
...
func (controller *Controller) GetHorizontalAxis(c *gin.Context) {
	...
	if len(_values) == 1 {
		...
		if len(value) == 1 {
			stackPath = value[0]
			// log.Println("GetHorizontalAxis", "Name", stackPath)
		}
	}
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
...
func (controller *Controller) UpdateHorizontalAxis(c *gin.Context) {
	...
	if horizontalaxisOld != nil {
		models.OnAfterUpdateFromFront(backRepo.GetStage(), horizontalaxisOld, horizontalaxisNew)
	}
...
func (controller *Controller) DeleteHorizontalAxis(c *gin.Context) {
	...
	if len(_values) == 1 {
		...
		if len(value) == 1 {
			stackPath = value[0]
			// log.Println("DeleteHorizontalAxis", "Name", stackPath)
		}
	}
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
