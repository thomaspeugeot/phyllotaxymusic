...
func (controller *Controller) GetShapeCategorys(c *gin.Context) {
	...
	if len(_values) == 1 {
		...
		if len(value) == 1 {
			stackPath = value[0]
			// log.Println("GetShapeCategorys", "Name", stackPath)
		}
	}
...
func (controller *Controller) PostShapeCategory(c *gin.Context) {
	...
	if len(_values) == 1 {
		...
		if len(value) == 1 {
			stackPath = value[0]
			// log.Println("PostShapeCategorys", "Name", stackPath)
		}
	}
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
...
func (controller *Controller) GetShapeCategory(c *gin.Context) {
	...
	if len(_values) == 1 {
		...
		if len(value) == 1 {
			stackPath = value[0]
			// log.Println("GetShapeCategory", "Name", stackPath)
		}
	}
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
...
func (controller *Controller) UpdateShapeCategory(c *gin.Context) {
	...
	if shapecategoryOld != nil {
		models.OnAfterUpdateFromFront(backRepo.GetStage(), shapecategoryOld, shapecategoryNew)
	}
...
func (controller *Controller) DeleteShapeCategory(c *gin.Context) {
	...
	if len(_values) == 1 {
		...
		if len(value) == 1 {
			stackPath = value[0]
			// log.Println("DeleteShapeCategory", "Name", stackPath)
		}
	}
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
