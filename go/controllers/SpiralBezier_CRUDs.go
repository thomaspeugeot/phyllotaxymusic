...
func (controller *Controller) GetSpiralBeziers(c *gin.Context) {
	...
	if len(_values) == 1 {
		...
		if len(value) == 1 {
			stackPath = value[0]
			// log.Println("GetSpiralBeziers", "Name", stackPath)
		}
	}
...
func (controller *Controller) PostSpiralBezier(c *gin.Context) {
	...
	if len(_values) == 1 {
		...
		if len(value) == 1 {
			stackPath = value[0]
			// log.Println("PostSpiralBeziers", "Name", stackPath)
		}
	}
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
...
func (controller *Controller) GetSpiralBezier(c *gin.Context) {
	...
	if len(_values) == 1 {
		...
		if len(value) == 1 {
			stackPath = value[0]
			// log.Println("GetSpiralBezier", "Name", stackPath)
		}
	}
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
...
func (controller *Controller) UpdateSpiralBezier(c *gin.Context) {
	...
	if spiralbezierOld != nil {
		models.OnAfterUpdateFromFront(backRepo.GetStage(), spiralbezierOld, spiralbezierNew)
	}
...
func (controller *Controller) DeleteSpiralBezier(c *gin.Context) {
	...
	if len(_values) == 1 {
		...
		if len(value) == 1 {
			stackPath = value[0]
			// log.Println("DeleteSpiralBezier", "Name", stackPath)
		}
	}
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
