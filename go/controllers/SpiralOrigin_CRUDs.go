...
func (controller *Controller) GetSpiralOrigins(c *gin.Context) {
	...
	if len(_values) == 1 {
		...
		if len(value) == 1 {
			stackPath = value[0]
			// log.Println("GetSpiralOrigins", "Name", stackPath)
		}
	}
...
func (controller *Controller) PostSpiralOrigin(c *gin.Context) {
	...
	if len(_values) == 1 {
		...
		if len(value) == 1 {
			stackPath = value[0]
			// log.Println("PostSpiralOrigins", "Name", stackPath)
		}
	}
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
...
func (controller *Controller) GetSpiralOrigin(c *gin.Context) {
	...
	if len(_values) == 1 {
		...
		if len(value) == 1 {
			stackPath = value[0]
			// log.Println("GetSpiralOrigin", "Name", stackPath)
		}
	}
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
...
func (controller *Controller) UpdateSpiralOrigin(c *gin.Context) {
	...
	if spiraloriginOld != nil {
		models.OnAfterUpdateFromFront(backRepo.GetStage(), spiraloriginOld, spiraloriginNew)
	}
...
func (controller *Controller) DeleteSpiralOrigin(c *gin.Context) {
	...
	if len(_values) == 1 {
		...
		if len(value) == 1 {
			stackPath = value[0]
			// log.Println("DeleteSpiralOrigin", "Name", stackPath)
		}
	}
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
