...
func (controller *Controller) GetSpiralCircles(c *gin.Context) {
	...
	if len(_values) == 1 {
		...
		if len(value) == 1 {
			stackPath = value[0]
			// log.Println("GetSpiralCircles", "Name", stackPath)
		}
	}
...
func (controller *Controller) PostSpiralCircle(c *gin.Context) {
	...
	if len(_values) == 1 {
		...
		if len(value) == 1 {
			stackPath = value[0]
			// log.Println("PostSpiralCircles", "Name", stackPath)
		}
	}
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
...
func (controller *Controller) GetSpiralCircle(c *gin.Context) {
	...
	if len(_values) == 1 {
		...
		if len(value) == 1 {
			stackPath = value[0]
			// log.Println("GetSpiralCircle", "Name", stackPath)
		}
	}
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
...
func (controller *Controller) UpdateSpiralCircle(c *gin.Context) {
	...
	if spiralcircleOld != nil {
		models.OnAfterUpdateFromFront(backRepo.GetStage(), spiralcircleOld, spiralcircleNew)
	}
...
func (controller *Controller) DeleteSpiralCircle(c *gin.Context) {
	...
	if len(_values) == 1 {
		...
		if len(value) == 1 {
			stackPath = value[0]
			// log.Println("DeleteSpiralCircle", "Name", stackPath)
		}
	}
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
