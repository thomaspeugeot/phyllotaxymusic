...
func (controller *Controller) GetBezierGridStacks(c *gin.Context) {
	...
	if len(_values) == 1 {
		...
		if len(value) == 1 {
			stackPath = value[0]
			// log.Println("GetBezierGridStacks", "Name", stackPath)
		}
	}
...
func (controller *Controller) PostBezierGridStack(c *gin.Context) {
	...
	if len(_values) == 1 {
		...
		if len(value) == 1 {
			stackPath = value[0]
			// log.Println("PostBezierGridStacks", "Name", stackPath)
		}
	}
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
...
func (controller *Controller) GetBezierGridStack(c *gin.Context) {
	...
	if len(_values) == 1 {
		...
		if len(value) == 1 {
			stackPath = value[0]
			// log.Println("GetBezierGridStack", "Name", stackPath)
		}
	}
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
...
func (controller *Controller) UpdateBezierGridStack(c *gin.Context) {
	...
	if beziergridstackOld != nil {
		models.OnAfterUpdateFromFront(backRepo.GetStage(), beziergridstackOld, beziergridstackNew)
	}
...
func (controller *Controller) DeleteBezierGridStack(c *gin.Context) {
	...
	if len(_values) == 1 {
		...
		if len(value) == 1 {
			stackPath = value[0]
			// log.Println("DeleteBezierGridStack", "Name", stackPath)
		}
	}
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
