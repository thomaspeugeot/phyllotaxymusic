...
import (
	...
	"github.com/thomaspeugeot/phylotaxymusic"
...
func ServeStaticFiles(logGINFlag bool) (r *gin.Engine) {
	...
	r.Use(static.Serve("/", EmbedFolder(phylotaxymusic.NgDistNg, "ng-github.com-thomaspeugeot-phylotaxymusic/dist/ng-github.com-thomaspeugeot-phylotaxymusic/browser")))
