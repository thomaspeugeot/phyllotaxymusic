...
func InitializeDatabase(stage *Stage) {
	__Axis__000000_Beat_Reference := (&Axis{}).Stage(stage)
	__Axis__000001_Construction_Axis := (&Axis{}).Stage(stage)
	__Axis__000002_Initial_Axis := (&Axis{}).Stage(stage)
	__Axis__000003_Pitch_Line := (&Axis{}).Stage(stage)
	__Axis__000004_Rotated_Axis := (&Axis{}).Stage(stage)

	__AxisGrid__000000_Beat_Lines := (&AxisGrid{}).Stage(stage)
	__AxisGrid__000001_Construction_Axis_Grid := (&AxisGrid{}).Stage(stage)
	__AxisGrid__000002_Pitch_Lines := (&AxisGrid{}).Stage(stage)

	__Bezier__000000_2nd_voice_seed := (&Bezier{}).Stage(stage)
	__Bezier__000001_First_Voice_seed := (&Bezier{}).Stage(stage)
	__Bezier__000002_Growth_Bezier_Right_Seed := (&Bezier{}).Stage(stage)
	__Bezier__000003_Growth_Curve_Next_Seed := (&Bezier{}).Stage(stage)
	__Bezier__000004_Growth_Curve_Next_Shift_Right_Seed := (&Bezier{}).Stage(stage)
	__Bezier__000005_Growth_Curve_Seed := (&Bezier{}).Stage(stage)
	__Bezier__000006_FirstVoiceShiftedRightSeed := (&Bezier{}).Stage(stage)

	__BezierGrid__000000_2nb_Voice := (&BezierGrid{}).Stage(stage)
	__BezierGrid__000001_2nd_voice_shifted_right := (&BezierGrid{}).Stage(stage)
	__BezierGrid__000002_First_Voice := (&BezierGrid{}).Stage(stage)
	__BezierGrid__000003_First_Voice_Shift_Right := (&BezierGrid{}).Stage(stage)
	__BezierGrid__000004_Growth_Curve := (&BezierGrid{}).Stage(stage)
	__BezierGrid__000005_Growth_Curve_Next := (&BezierGrid{}).Stage(stage)
	__BezierGrid__000006_Growth_Curve_Next_Shift_Right := (&BezierGrid{}).Stage(stage)
	__BezierGrid__000007_Growth_Curve_Shift_Right := (&BezierGrid{}).Stage(stage)

	__BezierGridStack__000000_The_GrowthCurveStack := (&BezierGridStack{}).Stage(stage)

	__Chapter__000000_Deep_into_the_phyllotaxy_growth_curve := (&Chapter{}).Stage(stage)
	__Chapter__000001_Composing_your_own_phyllotaxy_music := (&Chapter{}).Stage(stage)

	__Circle__000000_0 := (&Circle{}).Stage(stage)
	__Circle__000001_Construction_Circle := (&Circle{}).Stage(stage)
	__Circle__000002_First_voice_notes_seed := (&Circle{}).Stage(stage)
	__Circle__000003_Growing_Seed_Left := (&Circle{}).Stage(stage)
	__Circle__000004_Initial_Circle := (&Circle{}).Stage(stage)
	__Circle__000005_Rotated_Next_Circle := (&Circle{}).Stage(stage)

	__CircleGrid__000000_Construction_Circle_Grid := (&CircleGrid{}).Stage(stage)
	__CircleGrid__000001_First_Voice_note_shifted_right := (&CircleGrid{}).Stage(stage)
	__CircleGrid__000002_First_Voice_notes := (&CircleGrid{}).Stage(stage)
	__CircleGrid__000003_Growing_Circle_Grid := (&CircleGrid{}).Stage(stage)
	__CircleGrid__000004_Growing_Circle_Grid_Shifted_Left := (&CircleGrid{}).Stage(stage)
	__CircleGrid__000005_Initial_Circle_Grid := (&CircleGrid{}).Stage(stage)
	__CircleGrid__000006_Rotated_Circle_Grid := (&CircleGrid{}).Stage(stage)
	__CircleGrid__000007_Second_Voice_Notes_Shift_Right := (&CircleGrid{}).Stage(stage)
	__CircleGrid__000008_Second_Voice_notes := (&CircleGrid{}).Stage(stage)

	__Content__000000_Phyllotaxy_Music := (&Content{}).Stage(stage)

	__ExportToMusicxml__000000_Singloton := (&ExportToMusicxml{}).Stage(stage)

	__FrontCurve__000000_Non_Rotated_0_ := (&FrontCurve{}).Stage(stage)
	__FrontCurve__000001_Non_Rotated_1_ := (&FrontCurve{}).Stage(stage)
	__FrontCurve__000002_Non_Rotated_2_ := (&FrontCurve{}).Stage(stage)
	__FrontCurve__000003_Non_Rotated_3_ := (&FrontCurve{}).Stage(stage)
	__FrontCurve__000004_Non_Rotated_4_ := (&FrontCurve{}).Stage(stage)
	__FrontCurve__000005_Non_Rotated_5_ := (&FrontCurve{}).Stage(stage)
	__FrontCurve__000006_Non_Rotated_6_ := (&FrontCurve{}).Stage(stage)
	__FrontCurve__000007_Non_Rotated_7_ := (&FrontCurve{}).Stage(stage)

	__FrontCurveStack__000000_Front_Curve_Stack := (&FrontCurveStack{}).Stage(stage)

	__HorizontalAxis__000000_Horizontal_Axis := (&HorizontalAxis{}).Stage(stage)

	__Key__000000_F_key := (&Key{}).Stage(stage)

	__Parameter__000000_Reference := (&Parameter{}).Stage(stage)

	__Rhombus__000000_Growing_Rhombus_Grid_Seed := (&Rhombus{}).Stage(stage)
	__Rhombus__000001_Initial_Rhombus := (&Rhombus{}).Stage(stage)
	__Rhombus__000002_Rotated_Next_Rhombus := (&Rhombus{}).Stage(stage)
	__Rhombus__000003_Rotated_Rhombus := (&Rhombus{}).Stage(stage)

	__RhombusGrid__000000_Growing_Rhombus_Grid := (&RhombusGrid{}).Stage(stage)
	__RhombusGrid__000001_Initial_Rhombus_Grid := (&RhombusGrid{}).Stage(stage)
	__RhombusGrid__000002_Rotated_Rhombus_Grid := (&RhombusGrid{}).Stage(stage)

	__ShapeCategory__000000_0_Axes := (&ShapeCategory{}).Stage(stage)
	__ShapeCategory__000001_1_Initial := (&ShapeCategory{}).Stage(stage)
	__ShapeCategory__000002_2_Rotated := (&ShapeCategory{}).Stage(stage)
	__ShapeCategory__000003_3_Growing := (&ShapeCategory{}).Stage(stage)
	__ShapeCategory__000004_4_Construction := (&ShapeCategory{}).Stage(stage)
	__ShapeCategory__000005_5_Vertical_growth := (&ShapeCategory{}).Stage(stage)
	__ShapeCategory__000006_6_Spiral_growth := (&ShapeCategory{}).Stage(stage)
	__ShapeCategory__000007_7_Spiral_Growth_Bezier := (&ShapeCategory{}).Stage(stage)
	__ShapeCategory__000008_8_Score_notation := (&ShapeCategory{}).Stage(stage)
	__ShapeCategory__000009_9_Composer := (&ShapeCategory{}).Stage(stage)

	__SpiralBezier__000000_Spiral_Bezier_Seed := (&SpiralBezier{}).Stage(stage)

	__SpiralBezierGrid__000000_Spiral_Bezier_Full_Grid := (&SpiralBezierGrid{}).Stage(stage)
	__SpiralBezierGrid__000001_Spiral_Bezier_Grid := (&SpiralBezierGrid{}).Stage(stage)

	__SpiralCircle__000000_Construction_Circle_Spiral := (&SpiralCircle{}).Stage(stage)

	__SpiralCircleGrid__000000_Brute_Spiral_Bezier_Circle_Grid := (&SpiralCircleGrid{}).Stage(stage)
	__SpiralCircleGrid__000001_Construction_Circle_Spiral_Full_Grid := (&SpiralCircleGrid{}).Stage(stage)
	__SpiralCircleGrid__000002_Construction_Circle_Spiral_Grid := (&SpiralCircleGrid{}).Stage(stage)
	__SpiralCircleGrid__000003_Spiral_Circle_Grid := (&SpiralCircleGrid{}).Stage(stage)

	__SpiralLine__000000_Spiral_Contruction_Inner_Line := (&SpiralLine{}).Stage(stage)
	__SpiralLine__000001_Spiral_Contruction_Outer_Line := (&SpiralLine{}).Stage(stage)

	__SpiralLineGrid__000000_Spiral_Construction_Inner_Line_Grid_Spiral := (&SpiralLineGrid{}).Stage(stage)
	__SpiralLineGrid__000001_Spiral_Construction_Outer_Line_Full_Grid_Spiral := (&SpiralLineGrid{}).Stage(stage)
	__SpiralLineGrid__000002_Spiral_Construction_Outer_Line_Grid_Spiral := (&SpiralLineGrid{}).Stage(stage)

	__SpiralOrigin__000000_Spiral_Origin := (&SpiralOrigin{}).Stage(stage)

	__SpiralRhombus__000000_Reference_Spiral_Rhombus := (&SpiralRhombus{}).Stage(stage)

	__SpiralRhombusGrid__000000_Spiral_Rhombus_Grid := (&SpiralRhombusGrid{}).Stage(stage)

	__VerticalAxis__000000_Vertical_Axis := (&VerticalAxis{}).Stage(stage)
...
<p>Download the generated music score in the musescore musicxml format:
	...
	__Content__000000_Phyllotaxy_Music.Target = FILE
