...
func SerializeStage2(stage *Stage, filename string, addIDs bool) {
	...
	{
		// insertion point
		SerializeExcelizePointerToGongstruct2[*Axis](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*AxisGrid](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*Bezier](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*BezierGrid](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*BezierGridStack](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*Chapter](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*Circle](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*CircleGrid](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*Content](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*ExportToMusicxml](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*FrontCurve](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*FrontCurveStack](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*HorizontalAxis](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*Key](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*Parameter](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*Rhombus](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*RhombusGrid](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*ShapeCategory](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*SpiralBezier](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*SpiralBezierGrid](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*SpiralCircle](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*SpiralCircleGrid](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*SpiralLine](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*SpiralLineGrid](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*SpiralOrigin](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*SpiralRhombus](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*SpiralRhombusGrid](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*VerticalAxis](stage, f, addIDs)
	}
