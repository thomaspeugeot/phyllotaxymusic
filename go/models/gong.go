...
func GetFieldStringValueFromPointer[Type PointerToGongstruct](instance Type, fieldName string) (res string) {
	...
	case *MovingLine:
		...
		case "CenterY":
			res = fmt.Sprintf("%f", inferedInstance.CenterY)
		case "SpeedX":
			res = fmt.Sprintf("%f", inferedInstance.SpeedX)
		case "Color":
			res = inferedInstance.Color
		case "FillOpacity":
			res = fmt.Sprintf("%f", inferedInstance.FillOpacity)
	...
	case *Parameter:
		...
		case "NbBeatLinesPerCurve":
			res = fmt.Sprintf("%d", inferedInstance.NbBeatLinesPerCurve)
		case "FirstVoice":
