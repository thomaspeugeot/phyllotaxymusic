...
func GetFieldStringValueFromPointer[Type PointerToGongstruct](instance Type, fieldName string) (res string) {
	...
	case *Parameter:
		...
		case "MinuteScale":
			res = fmt.Sprintf("%f", inferedInstance.MinuteScale)
		case "BackendCurve":
		...
		case "BackendScale":
			res = fmt.Sprintf("%f", inferedInstance.BackendScale)
		case "Fkey":
