...
func GetFields[Type Gongstruct]() (res []string) {
	...
	case SpiralCircleGrid:
		res = []string{"Name", "IsDisplayed", "ShapeCategory", "SpiralRhombusGrid"}
	case SpiralRhombus:
