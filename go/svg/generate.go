...
func GenerateSvg(gongsvgStage *gongsvg_models.StageStruct, phylotaxymusicStage *phylotaxymusic_models.StageStruct) {
	...
	deltaX := parameter.DiamondSideLenght * math.Cos(math.Pi*parameter.DiamondAngle/180.0)
	deltaY := parameter.DiamondSideLenght * math.Sin(math.Pi*parameter.DiamondAngle/180.0)
