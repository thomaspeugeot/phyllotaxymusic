...
func FillUpForm[T models.Gongstruct](
	...
	case *models.Parameter:
		...
		AssociationFieldToForm("SpiralConstructionOuterLine", instanceWithInferedType.SpiralConstructionOuterLine, formGroup, probe)
		AssociationFieldToForm("SpiralConstructionInnerLine", instanceWithInferedType.SpiralConstructionInnerLine, formGroup, probe)
		AssociationFieldToForm("SpiralConstructionLineGrid", instanceWithInferedType.SpiralConstructionLineGrid, formGroup, probe)
