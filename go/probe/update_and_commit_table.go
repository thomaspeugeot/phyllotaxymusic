...
func updateAndCommitTablePointerToGongstruct[T models.PointerToGongstruct](
	...
	// insertion point
	case *models.Axis:
		updateAndCommitTable[models.Axis](probe)
	case *models.AxisGrid:
		updateAndCommitTable[models.AxisGrid](probe)
	case *models.Bezier:
		updateAndCommitTable[models.Bezier](probe)
	case *models.BezierGrid:
		updateAndCommitTable[models.BezierGrid](probe)
	case *models.BezierGridStack:
		updateAndCommitTable[models.BezierGridStack](probe)
	case *models.Chapter:
		updateAndCommitTable[models.Chapter](probe)
	case *models.Circle:
		updateAndCommitTable[models.Circle](probe)
	case *models.CircleGrid:
		updateAndCommitTable[models.CircleGrid](probe)
	case *models.Content:
		updateAndCommitTable[models.Content](probe)
	case *models.ExportToMusicxml:
		updateAndCommitTable[models.ExportToMusicxml](probe)
	case *models.FrontCurve:
		updateAndCommitTable[models.FrontCurve](probe)
	case *models.FrontCurveStack:
		updateAndCommitTable[models.FrontCurveStack](probe)
	case *models.HorizontalAxis:
		updateAndCommitTable[models.HorizontalAxis](probe)
	case *models.Key:
		updateAndCommitTable[models.Key](probe)
	case *models.Parameter:
		updateAndCommitTable[models.Parameter](probe)
	case *models.Rhombus:
		updateAndCommitTable[models.Rhombus](probe)
	case *models.RhombusGrid:
		updateAndCommitTable[models.RhombusGrid](probe)
	case *models.ShapeCategory:
		updateAndCommitTable[models.ShapeCategory](probe)
	case *models.SpiralBezier:
		updateAndCommitTable[models.SpiralBezier](probe)
	case *models.SpiralBezierGrid:
		updateAndCommitTable[models.SpiralBezierGrid](probe)
	case *models.SpiralCircle:
		updateAndCommitTable[models.SpiralCircle](probe)
	case *models.SpiralCircleGrid:
		updateAndCommitTable[models.SpiralCircleGrid](probe)
	case *models.SpiralLine:
		updateAndCommitTable[models.SpiralLine](probe)
	case *models.SpiralLineGrid:
		updateAndCommitTable[models.SpiralLineGrid](probe)
	case *models.SpiralOrigin:
		updateAndCommitTable[models.SpiralOrigin](probe)
	case *models.SpiralRhombus:
		updateAndCommitTable[models.SpiralRhombus](probe)
	case *models.SpiralRhombusGrid:
		updateAndCommitTable[models.SpiralRhombusGrid](probe)
	case *models.VerticalAxis:
		updateAndCommitTable[models.VerticalAxis](probe)
	default:
