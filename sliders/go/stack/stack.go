...
import (
	...
	"github.com/thomaspeugeot/phyllotaxymusic/sliders/go/fullstack"
	"github.com/thomaspeugeot/phyllotaxymusic/sliders/go/models"
	"github.com/thomaspeugeot/phyllotaxymusic/sliders/go/orm"
	"github.com/thomaspeugeot/phyllotaxymusic/sliders/go/probe"

	sliders_go "github.com/thomaspeugeot/phyllotaxymusic/sliders/go"
...
func (impl *BeforeCommitImplementation) BeforeCommit(stage *models.StageStruct) {
	...
	stage.Checkout()
	stage.Marshall(file, "github.com/thomaspeugeot/phyllotaxymusic/sliders/go/models", "main")
}
...
func NewStack(
	...
	if withProbe {
		stack.Probe = probe.NewProbe(r, sliders_go.GoModelsDir, sliders_go.GoDiagramsDir,
