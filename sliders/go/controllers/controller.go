...
import (
	...
	sliders_orm "github.com/thomaspeugeot/phyllotaxymusic/sliders/go/orm"
...
type Controller struct {
	...
	Map_BackRepos map[string]*sliders_orm.BackRepoStruct
...
func GetController() *Controller {
	doControllerInitOnce.Do(func() {
		_controllerSingloton = &Controller{
			Map_BackRepos: make(map[string]*sliders_orm.BackRepoStruct),
		}
	})
	return _controllerSingloton
}

func (controller *Controller) AddBackRepo(backRepo *sliders_orm.BackRepoStruct, stackPath string) {
