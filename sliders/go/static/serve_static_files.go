...
import (
	...
	"github.com/thomaspeugeot/phyllotaxymusic/sliders"
...
func ServeStaticFiles(logGINFlag bool) (r *gin.Engine) {
	...
	r.Use(static.Serve("/", EmbedFolder(sliders.NgDistNg, "ng-github.com-thomaspeugeot-phyllotaxymusic-sliders/dist/ng-github.com-thomaspeugeot-phyllotaxymusic-sliders/browser")))
