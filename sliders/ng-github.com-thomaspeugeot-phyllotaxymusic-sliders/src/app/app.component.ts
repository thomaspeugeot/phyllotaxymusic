...
import * as sliders from '../../projects/sliders/src/public-api'

import { SlidersspecificComponent } from '../../projects/slidersspecific/src/public-api'
...
export class AppComponent implements OnInit {
  ...
  sliders = 'Sliders'
  probe = 'Sliders Data/Model'
  view = this.sliders

  views: string[] = [this.sliders, this.probe];
