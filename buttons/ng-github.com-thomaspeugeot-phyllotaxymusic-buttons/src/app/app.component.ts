...
import * as buttons from '../../projects/buttons/src/public-api'

import { ButtonsspecificComponent } from '../../projects/buttonsspecific/src/public-api'
...
export class AppComponent implements OnInit {
  ...
  buttons = 'Buttons'
  probe = 'Buttons Data/Model'
  view = this.buttons

  views: string[] = [this.buttons, this.probe];
