...
import (
	...
	"github.com/thomaspeugeot/phyllotaxymusic/buttons"
...
func ServeStaticFiles(logGINFlag bool) (r *gin.Engine) {
	...
	r.Use(static.Serve("/", EmbedFolder(buttons.NgDistNg, "ng-github.com-thomaspeugeot-phyllotaxymusic-buttons/dist/ng-github.com-thomaspeugeot-phyllotaxymusic-buttons/browser")))
