...
import (
	...
	"github.com/thomaspeugeot/phyllotaxymusic/buttons/go/fullstack"
	"github.com/thomaspeugeot/phyllotaxymusic/buttons/go/models"
	"github.com/thomaspeugeot/phyllotaxymusic/buttons/go/orm"
	"github.com/thomaspeugeot/phyllotaxymusic/buttons/go/probe"

	buttons_go "github.com/thomaspeugeot/phyllotaxymusic/buttons/go"
...
func (impl *BeforeCommitImplementation) BeforeCommit(stage *models.StageStruct) {
	...
	stage.Checkout()
	stage.Marshall(file, "github.com/thomaspeugeot/phyllotaxymusic/buttons/go/models", "main")
}
...
func NewStack(
	...
	if withProbe {
		stack.Probe = probe.NewProbe(r, buttons_go.GoModelsDir, buttons_go.GoDiagramsDir,
