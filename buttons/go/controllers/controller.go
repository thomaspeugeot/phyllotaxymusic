...
import (
	...
	buttons_orm "github.com/thomaspeugeot/phyllotaxymusic/buttons/go/orm"
...
type Controller struct {
	...
	Map_BackRepos map[string]*buttons_orm.BackRepoStruct
...
func GetController() *Controller {
	doControllerInitOnce.Do(func() {
		_controllerSingloton = &Controller{
			Map_BackRepos: make(map[string]*buttons_orm.BackRepoStruct),
		}
	})
	return _controllerSingloton
}

func (controller *Controller) AddBackRepo(backRepo *buttons_orm.BackRepoStruct, stackPath string) {
