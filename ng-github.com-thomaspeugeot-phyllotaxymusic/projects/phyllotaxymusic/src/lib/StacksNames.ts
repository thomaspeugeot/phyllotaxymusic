...
export enum StacksNames {
	...
	GongLibButtonStackName = "button",
	GongLibSplitStackName = "root",
...
export const StacksNamesList: StacksNamesSelect[] = [ // insertion point	
	...
	{ value: StacksNames.GongLibButtonStackName, viewValue: "button" },
	{ value: StacksNames.GongLibSplitStackName, viewValue: "root" },
